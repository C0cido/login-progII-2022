...
def Ventas(menu):
    ...
    #cmb metodo de pago
    ttk.Label(menu,text="Metodo de Pago").place(x=650,y=480)
    ...
    #cmb proveedor
    ttk.Label(menu,text="Cliente").place(x=650,y=540)
    ttk.Entry(menu,textvariable=varCliente).place(x=780,y=540)
